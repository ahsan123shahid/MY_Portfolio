      ...
      <div className="mx-auto max-w-7xl flex flex-col gap-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 pb-12 border-b border-white/[0.04]">
          <div>
            ...
            <h3 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-white uppercase leading-none">
              Let&apos;s Collaborate
            </h3>
          </div>
          <a
            href="mailto:ahsan123shahid@gmail.com"
            className="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-full bg-white px-6 py-3.5 text-xs font-bold uppercase tracking-[0.15em] text-black transition-transform duration-300 hover:scale-105"
          >
